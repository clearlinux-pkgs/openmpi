...
Source0  : https://download.open-mpi.org/release/open-mpi/v4.0/openmpi-4.0.5.tar.gz
Source1  : openmpi
...
%prep
%setup -q -n openmpi-4.0.5
cd %{_builddir}/openmpi-4.0.5
%patch1 -p1
%patch2 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1606020478
...
cp %{_builddir}/openmpi-4.0.5/LICENSE %{buildroot}/usr/share/package-licenses/openmpi/3a8651f82da49e9b767fe0e427428c2bbb34ffb2
cp %{_builddir}/openmpi-4.0.5/contrib/dist/mofed/debian/copyright %{buildroot}/usr/share/package-licenses/openmpi/3a8651f82da49e9b767fe0e427428c2bbb34ffb2
cp %{_builddir}/openmpi-4.0.5/ompi/mca/topo/treematch/treematch/COPYING %{buildroot}/usr/share/package-licenses/openmpi/1d219195f5b198de4d80822b54ee0511f0d38361
cp %{_builddir}/openmpi-4.0.5/ompi/mca/topo/treematch/treematch/LICENSE %{buildroot}/usr/share/package-licenses/openmpi/80be8a39adf3f4419e3f7153aba2ae318eeec910
cp %{_builddir}/openmpi-4.0.5/opal/mca/event/libevent2022/libevent/LICENSE %{buildroot}/usr/share/package-licenses/openmpi/458149cf961c544a997c5de2d3df83cab6e2c08c
cp %{_builddir}/openmpi-4.0.5/opal/mca/hwloc/hwloc201/hwloc/COPYING %{buildroot}/usr/share/package-licenses/openmpi/23ae9dd3b06c170d1abfbdf517a2e4fea90b7cdd
cp %{_builddir}/openmpi-4.0.5/opal/mca/pmix/pmix3x/pmix/LICENSE %{buildroot}/usr/share/package-licenses/openmpi/c0fb365dcaaae482fe7c3673c97d0e8c6d21636d
%make_install
...
/usr/lib64/libmpi_usempif08.so.40.21.1
...
/usr/lib64/libopen-pal.so.40.20.5
/usr/lib64/libopen-rte.so
/usr/lib64/libopen-rte.so.40
/usr/lib64/libopen-rte.so.40.20.5
