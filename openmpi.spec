...
Patch3: fix-calculation-in-simple-grouping.patch
...
/usr/lib64/libmpi_usempif08.so.40.20.1
...
/usr/lib64/libopen-pal.so.40.20.2
/usr/lib64/libopen-rte.so
/usr/lib64/libopen-rte.so.40
/usr/lib64/libopen-rte.so.40.20.2
