...
%prep
%setup -q -n openmpi-4.1.4
cd %{_builddir}/openmpi-4.1.4
%patch1 -p1
%patch2 -p1
pushd ..
cp -a openmpi-4.1.4 buildavx2
popd
pushd ..
cp -a openmpi-4.1.4 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672765476
unset LD_AS_NEEDED
